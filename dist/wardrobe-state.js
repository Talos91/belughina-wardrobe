...
export const PLACES=[{id:'bedroom',name:'Cozy chic bedroom'},{id:'resort',name:'Seaside resort'},{id:'villa',name:'A little Tuscany'},{id:'manor',name:'Salami manor'},{id:'starlight',name:'Moonlit pastel room'},{id:'cafe',name:'Fashionista café'}];
export const PALETTE=[['Periwinkle','#aebde9'],['Lilac','#c6b6e2'],['Rose','#edb3c2'],['Buttercream','#f1dfb7'],['Sage','#b3c3a3'],['Original pearl','#f3eee5']];
export const DEFAULT_STATE={outfit:'base',top:null,bottom:null,hair:'bun',extras:[],glassesPosition:'eyes',colors:{},place:'bedroom',gentle:false,sparkles:true};
export function sanitizeState(value){
 const s={...DEFAULT_STATE,extras:[],colors:{}};if(!value||typeof value!=='object')return s;
 const oldRoom={atelier:'bedroom',seaside:'resort',greenhouse:'villa',moonlit:'starlight',scrapbook:'bedroom',pastel:'starlight',tuscany:'villa'};if(oldRoom[value.place])value={...value,place:oldRoom[value.place]};
...
export function thumbnail(id){return './assets/thumbnails/'+(['base','moonlight'].includes(id)?'outfits':'item')+'-'+id+'.png?v=wardrobe-clear-15';}
